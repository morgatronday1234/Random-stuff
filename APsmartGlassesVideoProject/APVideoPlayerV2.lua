...
INPUT: Box.mp4
OUTPUT: testVid/
mkdir tempTestVid && ffmpeg -i Box.mp4 -pix_fmt gray "tempTestVid\%d.bmp" && mkdir testVid && (for %f in (tempTestVid\*.bmp) do ffmpeg -i "%f" -f rawvideo -pix_fmt gray "testVid\%~nf.raw") && rmdir /S tempTestVid
--]]
